...
public class CommandRoleMap {
    ...
    static {
        ...
        ROLE_MAP.put(CommandType.LOGOUT, Arrays.asList(Role.USER,Role.ADMIN));
        ...
        ROLE_MAP.put(CommandType.FIND_USER_BY_PARAMETER, Arrays.asList(Role.ADMIN));
        ...
        ROLE_MAP.put(CommandType.TO_CHANGE_SERVICE, Arrays.asList(Role.ADMIN));
        ROLE_MAP.put(CommandType.TO_ADMIN_MAIN, Arrays.asList(Role.ADMIN));
        ROLE_MAP.put(CommandType.CHANGE_SERVICE, Arrays.asList(Role.ADMIN));
