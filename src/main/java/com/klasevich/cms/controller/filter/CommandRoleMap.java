 ...
 * The class contains EnumMap with commands and roles which are allowed to use this commands .
 */
public class CommandRoleMap {
     ...
     * @return true if command type contains such a role in the EnumMap
     */
