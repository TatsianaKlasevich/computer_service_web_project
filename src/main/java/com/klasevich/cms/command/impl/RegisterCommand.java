...
public class RegisterCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        CommandResult commandResult = new CommandResult(LOGIN, REDIRECT);
        ...
        try {
            if (service.userExists(mail)) {
                ...
                request.setAttribute("loginExistMessage", MessageManager.getProperty("message.login.exist"));
                commandResult = new CommandResult(MESSAGE_WARNING, FORWARD);
            } else {
               if(service.register(data,currentRole)){
                   ...
                   request.setAttribute(WELCOME_PAGE, MessageManager.getProperty("message.welcome.page"));
                   logger.debug("adding in bd {}, {}, {}, {}", name, surname, mail, phone);}
                       ...
                       commandResult = new CommandResult(ADMIN_MAIN, REDIRECT);
                   }
               }
               else {
                   ...
                   commandResult = new CommandResult(REGISTRATION, FORWARD);
               }
            }
