            ...
            <div class="content">
                <div class="main">
                    <div class="col">
                        <br/>
                        <br/>
                        <form method="post" action="orders_by_id.do">
                        ...
                        <form method="post" action="orders_by_category.do">
                        ...
                        <form method="post" action="orders_by_status.do">
                        ...
                        <form method="post" action="orders_after_date.do">
                    ...
                    <div class="col">
                        ...
                        <br/>
                        <form method="post" action="all_orders.do">
